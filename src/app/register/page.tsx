...
import { FlaskConical, Eye, EyeOff, AlertCircle, ArrowRight, ArrowLeft, CheckCircle2 } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] flex flex-col items-center justify-center px-6 py-12 font-sans">
      {/* Brand */}
          ...
          <div className="space-y-1.5">
            ...
            {password.length > 0 && (
              <ul className="space-y-1 pt-1">
                <PasswordRule met={rules.length} label="Minimal 8 karakter" />
              </ul>
            )}
          </div>
